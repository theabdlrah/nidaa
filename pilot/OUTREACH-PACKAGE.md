...
3. `ASSUMPTION-TRACKER.md` — the falsification ledger. **Must be updated after every conversation, before next steps.** Contains the 7 core assumptions + the required post-conversation template.
...
the post-conversation template in `ASSUMPTION-TRACKER.md` and update the tracker
table BEFORE discussing next steps. No "they liked it" summaries. If assumptions
1, 2, or 5 are strongly falsified by multiple conversations, the Pivot Rule fires
(pivot / narrow / stop) — this is a hard gate.
